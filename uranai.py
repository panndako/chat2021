...
# アイコンの指定
BOT_ICON = 'https://1.bp.blogspot.com/-_tnyZ46sJ_M/X1LsmD2uZOI/AAAAAAABa_w/FjmL4ow5bQY91MTkM63t5h_ADylNvTfrgCNcBGAsYHQ/s1600/yumekawa_angel_tenshi.png'
...
def run_chat(chat = chat, start='話しかけてね', **kw):

  def display_bot(bot_text):
    with output.redirect_to_element('#output'):
      bot_name = kw.get('bot_name', '話ちゃん')
